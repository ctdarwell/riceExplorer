#cluster accessions by haplotypes in gene regions
#calculate mean phenotype value according to happlotype
#evaluate whether mean phenotypes are > or < 95% CI
#output haplos/accessions assoc with extreme phenotypes
